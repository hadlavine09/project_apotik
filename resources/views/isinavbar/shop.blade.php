...
<body>
    ...
    <div class="site-section">
      <div class="container">
        ...
        @foreach ($obat as $data)
              ...
              {{ $data->stok }}
              {{ $data->harga }}
              {{ $data->kategori_obat->nama_kategori }}
               --}}
            
              <div class="col-sm-6 col-lg-4 text-center item mb-4">
                <span class="tag">Sale</span>
            <a href="/shop-single"> <img src="{{ $data->image() }}" style="width: 100px; height:100px" alt=""></a>
            <h3 class="text-dark"><a href="/shop-single">{{ $data->nama_obat }}</a></h3>
            <p class="price"><del>95.00</del> &mdash; 
              {{ $data->harga }}</p>
          </div>
          @endforeach

          {{-- <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <a href="/shop-single"> <img src="{{asset('assets1/images/product_02.png')}}" alt="Image"></a>
            <h3 class="text-dark"><a href="/shop-single">Chanca Piedra</a></h3>
            <p class="price">$70.00</p>
          </div>
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <a href="/shop-single"> <img src="{{asset('assets1/images/product_03.png')}}" alt="Image"></a>
          ...
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            ...
            <a href="/shop-single"> <img src="{{asset('assets1/images/product_04.png')}}" alt="Image"></a>
            <h3 class="text-dark"><a href="/shop-single">Cetyl Pure</a></h3>
            <p class="price"><del>45.00</del> &mdash; $20.00</p>
          </div>
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <a href="/shop-single"> <img src="{{asset('assets1/images/product_05.png')}}" alt="Image"></a>
            <h3 class="text-dark"><a href="/shop-single">CLA Core</a></h3>
            <p class="price">$38.00</p>
          </div>
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <span class="tag">Sale</span>
            <a href="/shop-single"> <img src="{{asset('assets1/images/product_06.png')}}" alt="Image"></a>
          ...
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <span class="tag">Sale</span>
            <a href="/shop-single"> <img src="{{asset('assets1/images/product_01.png')}}" alt="Image"></a>
          ...
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <a href="/shop-single"> <img ˀsrc="{{asset('assets1/images/product_03.png')}}" alt="Image"></a>
            <h3 class="text-dark"><a href="/shop-single">Umcka Cold Care</a></h3>
            <p class="price">$120.00</p>
          </div>
  ...
  <script src="{{asset('assets11/js/jquery-3.3.1.min.js')}}}"></script>
  <script src="{{asset('assets11/js/jquery-ui.js')}}}"></script>
  <script src="{{asset('assets11/js/popper.min.js')}}}"></script>
  <script src="{{asset('assets11/js/bootstrap.min.js')}}}"></script>
  <script src="{{asset('assets11/js/owl.carousel.min.js')}}}"></script>
  <script src="{{asset('assets11/js/jquery.magnific-popup.min.js')}}}"></script>
  <script src="{{asset('assets11/js/aos.js')}}}"></script>

  <script src="{{asset('assets11/js/main.js')}}}"></script>
